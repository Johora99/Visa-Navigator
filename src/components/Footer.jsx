...
export default function Footer() {
  return (
    <div className="w-full">
       ...
       <footer className="footer text-base-content container p-20 w-11/12 mx-auto">
  ...
  <nav>
    <h6 className="text-2xl font-semibold mb-3">Services</h6>
  ...
  <nav>
    <h6 className="text-2xl font-semibold mb-3">Company</h6>
  ...
  <nav>
    <h6 className="text-2xl font-semibold mb-3">Legal</h6>
